...
featured: false
---
Το NoScript είναι ένα από τα πιο ισχυρά εργαλεία ασφαλείας για τον περιηγητή — και ένα από τα παλαιότερα (2005). Η φιλοσοφία του: το JavaScript είναι ο κύριος φορέας επιθέσεων στο web· μην εκτελείτε κώδικα από ιστότοπους που δεν εμπιστεύεστε.
